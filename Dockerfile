...
RUN     apt-get update && \
        ...
        sed -i '1i #include <string>' horovod/common/group_table.h && \
        sed -i '1i #include <string>' horovod/common/group_table.cc && \
        sed -i '1i #include <stdexcept>' horovod/common/common.h && \
